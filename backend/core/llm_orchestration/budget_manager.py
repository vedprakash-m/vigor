            ...
            if user_id:
                ...
                if budget_usage:
                    return {
                        ...
                        "usage_percentage": (budget_usage.current_usage / budget_usage.budget_limit) * 100,
                        ...
                        "days_remaining": (budget_usage.reset_period_end - datetime.utcnow()).days
                    }
    ...
    async def get_global_status(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "global_limit": self._global_limit,
                "usage_percentage": (self._global_usage / self._global_limit) * 100,
                "status": "active" if self._global_usage < self._global_limit else "exceeded",
        ...
        try:
            ...
            for cache_key, budget_usage in self._usage_cache.items():
                if current_time >= budget_usage.reset_period_end:
                    ...
                    budget_usage.reset_period_end = current_time + timedelta(days=30)  # Default monthly
