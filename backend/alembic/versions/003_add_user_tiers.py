...
def upgrade():
    ...
    with op.batch_alter_table('user_profiles', schema=None) as batch_op:
        batch_op.add_column(sa.Column('user_tier', sa.String(), nullable=False, server_default='free'))
        batch_op.add_column(sa.Column('tier_updated_at', sa.DateTime(), nullable=True))
        batch_op.add_column(sa.Column('monthly_budget', sa.Float(), nullable=False, server_default='5.0'))
        batch_op.add_column(sa.Column('current_month_usage', sa.Float(), nullable=False, server_default='0.0'))
    ...
    op.create_table('user_usage_limits',
        ...
        sa.Column('weekly_requests_used', sa.Integer(), nullable=False, server_default='0'),
