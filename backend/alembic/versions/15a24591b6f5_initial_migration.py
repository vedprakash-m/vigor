...
def upgrade() -> None:
    ...
    sa.Column('equipment', sa.Enum('NONE', 'MINIMAL', 'MODERATE', 'FULL', name='equipment'), nullable=True),
    ...
    sa.Column('difficulty', sa.Enum('BEGINNER', 'INTERMEDIATE', 'ADVANCED', name='fitnesslevel'), nullable=True),
