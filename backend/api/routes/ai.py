...
async def get_provider_status():
    ...
    return {
        ...
        "provider_info": {
            "openai": {
                "configured": bool(settings.OPENAI_API_KEY and settings.OPENAI_API_KEY not in ["your-openai-api-key-here", "sk-placeholder"]),
            ...
            "perplexity": {
                "configured": bool(settings.PERPLEXITY_API_KEY and settings.PERPLEXITY_API_KEY != "your-perplexity-api-key-here"),
